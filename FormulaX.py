...
TRACK = scale_image(pygame.image.load('imgs/track2.png'), 0.5)

TRACK_BORDER = scale_image(pygame.image.load('imgs/track-border2.png'), 0.5)
TRACK_BORDER_MASK = pygame.mask.from_surface(TRACK_BORDER)
FINISH_LINE = scale_image(pygame.image.load('imgs/finish.png'), 0.8)
...
pygame.display.set_caption('Formula X')

MAIN_FONT = pygame.font.SysFont('comicsans', 44)

FPS = 60
PATH = [(527, 355), (708, 151), (646, 78), (515, 200), (448, 91), (115, 95), 
        (125, 224), (429, 254), (408, 335), (249, 391), (244, 475), (469, 702), (573, 679), (531, 534), (527, 488)]
...
def draw(win, images, player_car, computer_car, game_info):
    ...
    win.blit(level_text, (10, HEIGHT - level_text.get_height() - 85))
...
def handle_collision(player_car, computer_car, game_info):
    ...
    player_finish_poi_collide = player_car.collide(FINISH_LINE_MASK, *FINISH_LINE_POS)
...
images = [(GRASS, (0,0)), (TRACK, (0,0)), (FINISH_LINE, FINISH_LINE_POS), (TRACK_BORDER, (0,0))]
...
while run:
    ...
    if game_info.game_finished():
        blit_text_center(WIN, MAIN_FONT, 'Ganaste papuuuu!')
        pygame.display.update()
        pygame.time.wait(5000)
        game_info.reset()
        player_car.reset()
